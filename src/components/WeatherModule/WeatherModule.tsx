...
const WeatherModule = ({
  ...
  return (
    <>
      <div className="weather-module bg-stone-50/60 rounded-lg grid gap-x-1 gap-y-0  aspect-3/2 w-90 h-28 md:w-50 md:h-60 place-self-center mb-3 px-1 inset-shadow-sm inset-shadow-stone-450/15">
        ...
        <div className="col-span-1 row-span-1 col-start-2 md:col-start-1 md:row-start-2 md:col-span-2 place-self-center">
          <WeatherIcon
            ...
            className="w-15 rounded-full shadow-lg bg-lime-900/30"
          />
        </div>
        <Temperature
          tempUnit={tempUnit}
        ...
        <div className="col-span-1 col-start-2 row-start-2 md:row-start-5 md:col-start-1 md:col-span-2 w-26 md:w-50 h-10 text-sm place-self-center text-center content-center md:-mt-10">
          <p>{weatherCodeToString(weather_code, isDay)}</p>
        </div>
      </div>
    </>
  );
